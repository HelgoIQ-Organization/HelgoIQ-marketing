...
**Status:** Approved and built. UI shipped on this branch; live deploy is a separate step.  
...
**Approved.** UI is built on this branch. Photos, demo video, live metrics, and helgoiq.com deploy remain separate.
